local Library = loadstring(game:HttpGet("https://pastebin.com/raw/abwH29f1"))()
local Window = Library:Window()

local games = {
    [863266079] = "XoticVolth/ar2",
}
getgenv().ConfigFolder = games[game.GameId] or "XoticVolth/universal"
